 ...
 * one image will automatically scroll the others.
 */
public class DisplayThreeSynchronizedImages extends JPanel implements AdjustmentListener {
	/**
	 * 
	 */
	private static final long serialVersionUID = -3220472533640021211L;
	 ...
	 * creating three instances of DisplayJAI for the images and
	...
	public DisplayThreeSynchronizedImages(RenderedImage im1, RenderedImage im2, RenderedImage im3) {
		...
		jsp1 = new JScrollPane(dj1); // JScrollPanes for the instances of
										// DisplayJAI.
	 ...
	 * ofDisplayJAI are changed. The method will adjust the scroll bar of the
