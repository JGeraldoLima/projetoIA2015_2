 ...
 * DisplayJAI. The scrolling bars of the images are synchronized so scrolling
 * one image will automatically scroll the other. This class does not extends
...
public class DisplayFourSynchronizedImages extends JPanel implements AdjustmentListener {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5262801321863004017L;
	 ...
	 * 
	 * @param im1
	 *            the first image (top left side)
	 * @param im2
	 *            the second image (top right side)
	 * @param im3
	 *            the third image (bottom left side)
	 * @param im4
	 *            the fourth image (bottom right side)
	 */
	public DisplayFourSynchronizedImages(RenderedImage im1, RenderedImage im2, RenderedImage im3, RenderedImage im4) {
		super();
	...
	public void adjustmentValueChanged(AdjustmentEvent e) {
		...
		if (e.getSource() == jsp1.getHorizontalScrollBar()) {
			// We change the position of the horizontal bar of the 2nd, 3rd and
			// 4th images.
		...
		if (e.getSource() == jsp1.getVerticalScrollBar()) {
			// We change the position of the vertical bar of the 2nd, 3rd and
			// 4th images.
		...
		if (e.getSource() == jsp2.getHorizontalScrollBar()) {
			// We change the position of the horizontal bar of the 1st, 3rd and
			// 4th images.
		...
		if (e.getSource() == jsp2.getVerticalScrollBar()) {
			// We change the position of the vertical bar of the 1st, 3rd and
			// 4th images.
		...
		if (e.getSource() == jsp3.getHorizontalScrollBar()) {
			// We change the position of the horizontal bar of the 1st, 2nd and
			// 4th images.
			jsp1.getHorizontalScrollBar().setValue(e.getValue());
			jsp2.getHorizontalScrollBar().setValue(e.getValue());
			jsp4.getHorizontalScrollBar().setValue(e.getValue());
		...
		if (e.getSource() == jsp3.getVerticalScrollBar()) {
			// We change the position of the vertical bar of the 1st, 2nd and
			// 4th images.
			jsp1.getVerticalScrollBar().setValue(e.getValue());
			jsp2.getVerticalScrollBar().setValue(e.getValue());
			jsp4.getVerticalScrollBar().setValue(e.getValue());
