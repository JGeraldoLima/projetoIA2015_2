 ...
 * mouse cursor.
 */
public class DisplayGrayHistogram extends JComponent implements MouseMotionListener {
	/**
	 * 
	 */
	 ...
	 */
	public DisplayGrayHistogram(Histogram histogram, int band, String title) {
